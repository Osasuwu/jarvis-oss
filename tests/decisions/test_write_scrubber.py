...
from record_decision_doubles import make_client
...
class TestLogBlockEvent:
    def test_inserts_counter_event_no_values(self, monkeypatch):
        monkeypatch.setenv("JARVIS_REPO_SLUG", "example-owner/example-repo")
        client = MagicMock()
        ...
        assert row["repo"] == "example-owner/example-repo"
