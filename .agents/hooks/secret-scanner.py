...
# CUSTOMIZE: list whichever env vars your own project stores credentials in.
_SECRET_VARS = r"API_KEY|API_TOKEN|ACCESS_TOKEN|SECRET_KEY|DATABASE_URL"
...
# body exposed to BASH_DANGER_PATTERNS.
