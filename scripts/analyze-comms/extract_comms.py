...
# Harness-generated messages that arrive with role=user but are NOT the human typing.
# Leaving these in poisons corrective/affirmative stats downstream (~90% of NEG_RE
# hits in the 2026-07-15 run were these three families).
SYSTEM_USER_PREFIXES = (
    "This session is being continued from a previous conversation",  # compaction summary
    "Base directory for this skill:",  # skill payload injection
    "Stop hook feedback:",  # Stop-hook nudge
    "Caveat: The messages below were generated by the user while running local commands",
    "Continue from where you left off.",  # harness continuation prompt
